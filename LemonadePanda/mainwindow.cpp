...
void MainWindow::createRooms()  {
    ...
    s = new room('s', 0, "The glass wall behind you is eluminating the main entrance of the building. There is two staircases, one to your left the other to your right. "
                            ...
                            "Behind you is the main exit to the building, unfortunately it's locked with a 10 letter passkey. Maybe if you look around you'll see it written down somewhere");
    ...
    r2 = new room('r', 2, "As you enter the room you see a nice view of the little garden, the weather looks great to just go out and have a picnic. The room itself is fairly empty just a few couches that"
                            " students used to take up. To your left is an elevator however it appears as if the power isn't working. Seeing as its so nice outside you didn't notice that all the lights aren't working.");
    r3 = new room('r', 3, "Room 3 is an empty, as you enter it you are met with empty desk and chairs. Written on the white board is stay at 127.0.0.1 wear a 255.255.255.0, guess a comp sci student was here before lockdown. "
                            "On the wall infront of you, you notice another letter written in blue marker. Maybe you should start taking them down and see what it spells??");
    r4 = new room('r', 4, "The smell of saw dust and wood, hits you as you walk into room 4. There are a few unfinished projects left around the room on the desk tops. At the back of the room there is a door with a staircase "
                            " behind it. The stairs lead to hallway 4.");
    r5 = new room('r', 5, "h5, NULL, NULL, NULL");
    r6 = new room('r', 6, "r9, h2, r6_3, r1");
    r7 = new room('r', 7, "h3, h6, NULL, h4");
    r8 = new room('r', 8, "h4, NULL, NULL, NULL");
    r9 = new room('r', 9, "h4, NULL, NULL, NULL");
    r10 = new room('r', 10, "r9, NULL, NULL /*12*/, NULL");
    r11 = new room('r', 11, "h10, NULL/*secret*/, NULL, NULL");
    h1 = new room('h', 1, "r4, r1, r2, r3");
    h2 = new room('h', 2, "h7, NULL, NULL, r6");
    h3 = new room('h', 3, "NULL, s, r7, s");
    h4 = new room('h', 4, "r4, r7, r8, h5");
    h5 = new room('h', 5, "NULL, h4, r5, NULL");
    h6 = new room('h', 6, "NULL, NULL, NULL, r7");
    h7 = new room('h', 7, "h2, NULL/*h11*/, NULL, r9");
    h8 = new room('h', 8, "NULL/*15*/, h10, NULL, NULL/*14*/");
    h9 = new room('h', 9, "NULL/*23*/, NULL, NULL, NULL");
    h10 = new room('h', 10, "h8, NULL/*h15*/, r11, NULL/*h15*/");
    r6_3 = new room('r', 6.3, "r6, NULL, NULL, NULL");

    h11 = new room ('h', 11, "There is a staircase north, leading downn to hallway 7, To your left there is a door to room 12.");
    r12 = new room ('r', 12, "There is a staircase south, leading you to room 10. There is hallway 12 to your left, and hallway 11 to your right. Hallway 11 has a staircase leading down to hallway 7.");
    h12 = new room ('h', 12, "North is room 13, To your right is room 12 and to your left is hallway 13.");
    h13 = new room ('h', 13, "To your right is hallway 12 and to your left is hallway 14.");
    h14 = new room ('h', 14, "To your right is hallway 13 and to your left is room 14.");
    r14 = new room ('r', 14, "To your right there is hallway 14, south is a staircase leading to hallway 8. North you can see another staircase leading to a room but there is no access to the staircase from this room.");
    r15 = new room ('r', 15, "To the right is a staircase leading to hallway 8.");
    h21 = new room ('h', 21, "North is a staircase leading to hallway 23. South is a staircase leading to hallway 9 which has the exit to stables.");
    h15 = new room ('h', 15, "Right is an elevator that goes to up to hallway 24, if you take north, and down to hallway 10. To your left are stairs that lead to up to hallway 24 and down to hallway 10. South leadss to hallway 17.");
    h17 = new room ('h', 17, "North leads to hallway 15. To your right, at the end of the hallway, you can see another staircase to the right and a room south, but they aren't acessble as there is some construction blocking your way.");
    h16 = new room ('h', 16, "To your right is a staircase leading to hallway 25. South is room 16. To your left is the rest of the hallway but it's blocked with construction, however you can see a door north of the hallway.");
    r16 = new room ('r', 16, "North is teh exit to halway 16.");
    h18 = new room ('h', 18, "North is room 17. To your right is hallway 19.");
    h19 = new room ('h', 19, "North is room 18. To your left is room 20. South is elevator to room 2.");
    r20 = new room ('r', 20, "North is hallway 20. South is hallway 22. To your right is hallway 19.");
    h20 = new room ('h', 20, "South is room 20.");
    h22 = new room ('h', 20, "North is room 20. To the right is room 21. South is room 24.");
    r21 = new room ('r', 21, "North is room 22. South is room 23.");
    r22 = new room ('r', 22, "South is room 21.");
    r23 = new room ('r', 23, "North is room 21.");
    r24 = new room ('r', 24, "North is hallway 22. Left is hallway 23. South is room 25.");
    h23 = new room ('h', 23, "North is a staircase that takes you to hallway 21. South is room 27.");
    r27 = new room ('r', 27, "North is hallway 23.");
    r25 = new room ('r', 25, "North is room 24. South is hallway 24.");
    h24 = new room ('h', 24, "Left is a staircase to hallway 15. Right is an elevator to hallway 15. North is room 25. South is hallway 25.");
    h25 = new room ('h', 25, "North is hallway 24. South is room 26. To the right as the end of the hallway is a staircase that leads to hallway to 16.");
    r26 = new room ('r', 26, "North is hallway 25.");
