...
void MainWindow::createRooms()  {
    ...
    s = new roomInBuilding('s', 0, "The glass wall behind you is illluminating the main entrance of the building. There is two staircases, one to your left the other to your right. "
                            ...
                            "Exits: North leads outside [locked]. South is room 1. West and East both lead to hallway 3 [floor 2].", false);
        s->addItem(new Item("Plant 1", "A small looking palm tree in a pot. About a meter tall.", false));
        //plant 2 can be watered have a water bottle in your bag. The water makes a bloop bloop sound as it comes out of the bottle
        s->addItem(new Item("Plant 2", "A small looking palm tree in a pot. About a meter tall. It looks a bit wilted.", false));
        s->setFloorNum(1);

    r1 = new roomInBuilding('r', 1, "The main lecture hall in the builing. As you walking in you see 200 red seats facing you. You remember how stressful it was to give presentations infront of everyone. To your right is "
        ...
        r1->addItem(new Item("Desk Chair","A desk chair with wheels.",false));

         r1->addRoomToFloor();

    r2 = new roomInBuilding('r', 2, "As you enter the room you see a nice view of the little garden, the weather looks great to just go out and have a picnic. The room itself is fairly empty just a few couches that"
        ...
        r2->addItem(new Item("Sticky note","There's a letter O written on it.", true));

    r3 = new roomInBuilding('r', 3, "Room 3 is an empty classroom, as you enter it you are met with empty desks and chairs. Written on the white board is stay at 127.0.0.1 wear a 255.255.255.0, "
        ...
        r3->addItem(new Item("Fluffy Pencilcase ", "The fluffy pink pencilcase appears to be full of stationary to a point where there is a little whole starting to tear at the seam of the zip.", true));

    r4 = new roomInBuilding('r', 4, "The smell of saw dust and wood, hits you as you walk into room 4. All the tools are neatly put away in their proper places. It's shame that the power isn't working you were alway interested in"
        ...
        r4->addItem(new Item("Drill", "It a blue drill by some good brand. There is no drill bits in it though. It's locked to the wall by an extenable wire", false));
        //You get a splinter if you pick it up but it also reveals the letter E on its underside
        r4->addItem(new Item("Project", "It looks like a silloutte of a guitar. The edges appear to be rough and not sanded down.", false));
        //If you try to pick it you change you mind because it looks sharp
        r4->addItem(new Item("Saw", "The blade looks very sharp and dangerous.", false));
        r4->addItem(new Item("Sandpaper", "Its rough just like being on 3 hours of sleep and 4 coffees.", true));

    r5 = new roomInBuilding('r', 5, "The room is an empty office admin looking room. There's a stack of student guidebooks and handbooks in the left corner of the room. There is also some UL merch, propabaly left over from an open "
         ...
         r5->addItem(new Item("Silver Key", "A small silver key. It has a tag with number 6 written on it.", true));
         r5->addItem(new Item("Student Guidebook", "It has some basic information about the buildings, an FAQ with questions regarding admin things such as fees, accommodation. It also has contact information for year heads"
                            " and fees office etc.", true));
         //if you open it the letter L is written inside the cover with blue marker
         r5->addItem(new Item("Student Handbook", "Outlines the rules of conduct in UL.", true));

    r6 = new roomInBuilding('r', 6, "Room 6 is a large open room. You originally remember it from the open day when you went back in 6th year of secondary school. This is where you found the stall for computer science."
        ...
        r6->addItem(new Item("1d4 Blue Dice", "Its a pyramid shaped dice. Its main color is blue and the numbers are painted on with white However the number 1 is tipex over with to make it look like an A.", true));

    r6_3 = new roomInBuilding('r', 6.3, "The nostaligia hits you as you enter the small room. The memories of fighting dire wolfs, golblins, spending too much gold bits on beer after a successful adventure all flood your mind. "
        ...
        r6_3->addItem(new Item("Gold key", "Its a small gold key with a tag on it. The tag has s written on it", true));
        //when you pick up the blue marker the cap drops under the table and you notice the gold key
        r6_3->addItem(new Item("Blue Marker", "It's a white boards marker thats blue.", false));
        //dried out so can't write
        r6_3->addItem(new Item("Red Marker", "It's a white boards marker thats red.", false));

    r7 = new roomInBuilding('r', 7, "Another lecture theatre this one is much smaller and looks like a classroom with extra seats. It has a blackboard which is rare to see since a lot of the other classroom and lecture halls use"
        ...
        r7->addItem(new Item("Maths book", "Discrete Mathematics: An Open Introduction by Oscar Levin.", false));

    r8 = new roomInBuilding('r', 8, "Room 8 is another empty classroom. This time all the chairs are stacked up against the left wall and the desks as all next to each other against the back wall. "
                            " "
                            "guess a comp sci student was here before lockdown. There appears to be a pink fluffy pencil case left on one of the desks.",
                            "Exits: North hallway 4", false);
    r9 = new roomInBuilding('r', 9, "h4, NULL, NULL, NULL",
                                    "Exits: North is stairs to room 6. South is room 10. East is hallway 7.", false);
    r10 = new roomInBuilding('r', 10, "r9, NULL, 12, NULL",
                                    "Exits: North is room 9.", true);

    h1 = new roomInBuilding('h', 1, "A short hallway with a door on each wall",
                            "Exits: North is room 4. South is room 2. West is room 3. East is room 1.", false);
    h2 = new roomInBuilding('h', 2, "It's just a small stairwell leading to hallway 7.",
                            "Exits: North is hallway 7 [floor 2]. West is room 6.", false);
    h3 = new roomInBuilding('h', 3, "The glass wall from the room below extends to this level. There is a small balcony space allowing you to look down onto room S. Infront of the balcony wall there is a few couches.",
                            "Exits: East and West both lead to room S [floor 1]. South leads to room 7. ", false);
    h4 = new roomInBuilding('h', 4, "It's a long L shaped hallway. There are stairs leading to room 4 at one end of it. At the other end is the door to room 7. Door to hallway 5 is across from the door to room 7. "
    ...
    h5 = new roomInBuilding('h', 5, "Another L shaped. At one end of the L are the stairs down to room 5",
                            "Exits: East is hallway 4. South are stairs leading to room 5 [floor 1].", false);
    h6 = new roomInBuilding('h', 6, "A small dead end hallway. It's filled with a bunch of sealed boxes and some spare desks and chairs.",
                            "Exits: West is room 7", false);
    h7 = new roomInBuilding('h', 7, "It's just a small stairwell leading to hallway 2.",
...
void MainWindow::printWelcome() {
    ...
    mainText = "Hello Welcome\n" + currentRoom->getLongDescription() + currentRoom->longDescription();
...
bool MainWindow::processCommand(int buttonNumber) {
    ...
    if (buttonNumber == 4){
        ...
        map->setStyleSheet(lblBg);
        map->setWordWrap(true);

        int x = sizeof(mapImages)/sizeof(mapImages[0]);
        for (int i = 0; i < x; i++){
        ...
        //take  button
        mainText = currentRoom->getLongDescription() + currentRoom->longDescription();
        ui->mainBox->setText(mainText);
        itemText = currentRoom->displayItem();
        ui-> itemTextBox->setWordWrap(true);
        ui->itemTextBox->setText(itemText);
        ...
        if (getBagItems().size() < 5 ){
            for (int i = 0; i < x; i++){
                ...
                connect(Button, &QPushButton::clicked, this, [=]() {
                    if(itemsInRoom[i].getPickUp() == true){
                        addToBag(itemsInRoom[i]);
                        currentRoom->removeItem(i);
                        ui->mainBox->setText(mainText + "\nYou took " + itemsInRoom[i].getShortDescription());
                        newWin->hide();
                   } else {
                        ui->errorLabel->setText("You can't take this.");
        ...
        if (x != 0){
            ...
            ui->errorLabel->setText("No items in bag to put down.");
            ui-> errorLabel->setWordWrap(true);
            QTimer::singleShot(0, ui->errorLabel, &QLabel::show);
            QTimer::singleShot(3000, ui->errorLabel, &QLabel::hide);
        }
    ...
    //inspect item
        ...
        for (int i = 0; i < x; i++){
            ...
            connect(Button, &QPushButton::clicked, this, [=]() {
                ...
                newWin2->setStyleSheet(winBg);
                QVBoxLayout *layout2 = new QVBoxLayout();
                newWin2->setGeometry(500,400,200,200);
                newWin2->setWindowTitle(itemsInRoom[i].getShortDescription());

                QLabel *label = new QLabel();
                label->setStyleSheet(lblBg);
                label->setFont(font);
                label->setWordWrap(true);
                label->setText(itemsInRoom[i].getLongDescription());
                QPushButton *Inspect = new QPushButton();
                Inspect->setFont(font);
                Inspect->setStyleSheet(btnBg);
                Inspect->setText("inspect");
                Inspect->setObjectName("Button" + QString::number(i));
                connect(Inspect, &QPushButton::clicked, this, [=]() {
                    inspectitem *item = new inspectitem();
                    objInteract = item->ifStatementsForItems(itemsInRoom[i]);
                    ui->mainBox->setText(mainText + objInteract);
                 });
                layout2->addWidget(Inspect);
...
void MainWindow::go(string direction) {
    roomInBuilding* nextRoom = currentRoom->nextRoom(direction);
